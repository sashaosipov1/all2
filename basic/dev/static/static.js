(function () {
    let cont = document.querySelector('#container_a2_static');
    let plid = cont.getAttribute('data-plid');
    let contWidth = cont.getAttribute('data-cont-width') || 350;
    let contHeight = cont.getAttribute('data-cont-height') || 300;
    let contWidthMobile = cont.getAttribute('data-cont-width-mobile') || 250;
    let contHeightMobile = cont.getAttribute('data-cont-height-mobile') || 200;
    ...
    let markup = `<link rel="stylesheet" href="${globalUri}players/static/main.css">
    ...
    let markupMobile = `<link rel="stylesheet" href="${globalUri}players/static/main_mobile.css">
    <meta charset="utf-8">
    <div>
        ...
        <div id="videoPlayer_a2">
            <a id="export" target="_blank"><video preload="auto" muted playsinline autoplay="autoplay" id="video"></video></a>
        </div>
    </div>`;
    ...
    function initContainer() {
        ...
        if (!mobileBool) {
            ...
            cont.style.width = contWidthMobile + 'px';
            cont.style.height = contHeightMobile + 'px';
        }
    ...
    function PlayingParams() {
        if (!mobileBool) {
            fr.width = contWidth;
            fr.height = contHeight;
        } else {
            fr.width = contWidthMobile;
            fr.height = contHeightMobile;
        }
